...
import { LLMRouter } from '../lib/llm-clients/llm-router.js';
import { ConciergeEngine } from '../lib/prompt-engine/concierge-engine.js';
...
class PromptTester {
  ...
  createMockEngine() {
    ...
    return {
      async processInvestorQuery(query) {
  ...
  async runSingleTest(engine, testCase) {
