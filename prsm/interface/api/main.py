...
from prsm.core.auth.middleware import AuthMiddleware, SecurityHeadersMiddleware
...
from prsm.core.security.enhanced_authentication import (
    initialize_auth_system, get_auth_system
)
from prsm.core.security.security_monitoring import (
    initialize_security_monitor, get_security_monitor, shutdown_security_monitor
)
from prsm.core.security.security_analytics import (
...
try:
    ...
    from prsm.core.integrations.api.security_api import security_router
