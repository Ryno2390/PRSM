...
The module `venv/lib/python3.13/site-packages/uvicorn/protocols/websockets/__init__.py` is currently empty or has minimal content. This file should contain:
...
### Files to Modify
venv/lib/python3.13/site-packages/uvicorn/protocols/websockets/__init__.py
