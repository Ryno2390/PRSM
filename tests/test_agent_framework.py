...
class AgentFrameworkTester:
    ...
    async def test_individual_agents(self):
        ...
        try:
            ...
            if response.success:
                candidates = response.output_data
        ...
        try:
            ...
            response = await compiler.safe_process(
                mock_results,
                {"session_id": self.test_session_id, "strategy": "hierarchical"}
            )
    ...
    async def test_agent_coordination(self):
        ...
        try:
            ...
            architect = self.agents["architect"]
            task = "Research and analyze the environmental impact of renewable energy technologies"
            ...
            if router_response.success:
                candidates = router_response.output_data
