#!/usr/bin/env python3
"""
NWTN Model Optimization Script for command-r
===============================================

This script performs the actual optimization of command-r for NWTN reasoning.
"""
...
def log_progress(message):
    ...
    # Also log to file
    with open("models/nwtn_optimized/command-r_optimization_logs.txt", "a") as f:
        f.write(f"[{timestamp}] {message}\n")

def main():
    log_progress("🚀 Starting NWTN optimization for command-r")
    
    # Load configuration
    with open("models/nwtn_optimized/command-r_optimization_config.json", "r") as f:
        config = json.load(f)
    ...
    training_data_path = "data/nwtn_training/nwtn_training_data_command-r.json"
