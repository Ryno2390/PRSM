...
from prsm.economy.marketplace.initial_listings import launch_marketplace_with_initial_listings
...
async def get_launch_status(
    ...
    """
    try:
        from prsm.economy.marketplace.initial_listings import initial_listings_creator
