#!/usr/bin/env python3
"""
Integration Test for Deployed command-r Model
===============================================

This script tests the deployed command-r model's integration with NWTN.
"""
...
async def test_deployed_model():
    ...
    print("🧪 Testing deployed command-r model integration")
    print("=" * 50)
    
    # Load deployment config
    try:
        with open("config/nwtn/command-r_deployment_config.json", "r") as f:
            config = json.load(f)
    ...
    for i, test in enumerate(test_cases, 1):
        ...
        print("   🔄 Processing with command-r model...")
