...
from prsm.compute.agents.routers.marketplace_integration import marketplace_integration
from prsm.compute.agents.routers.performance_tracker import performance_tracker, MetricType, ModelPerformanceProfile
from prsm.compute.agents.routers.tool_router import ToolRouter, ToolRequest, ToolRoutingDecision
    ...
    async def _discover_hybrid_candidates(self, task_description: str) -> List[ModelCandidate]:
        ...
        try:
            ...
            if "chemistry" not in self.hybrid_executors:
                ...
                try:
                    from prsm.compute.nwtn.chemistry_hybrid_executor import ChemistryHybridExecutor
            ...
            if "general" not in self.hybrid_executors:
                try:
                    from prsm.compute.nwtn.hybrid_architecture import create_hybrid_nwtn_engine
