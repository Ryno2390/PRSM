...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('crypto_amount', sa.Numeric(30, 18)),
        sa.Column('crypto_currency', sa.String(20), nullable=False),
        sa.Column('exchange_rate', sa.Numeric(30, 18)),
        sa.Column('processing_fee', sa.Numeric(18, 2), default=0),
        sa.Column('network_fee', sa.Numeric(18, 8), default=0),
        sa.Column('status', sa.String(50), nullable=False, default='pending'),
        sa.Column('payment_method', sa.String(50)),
        sa.Column('provider_reference', sa.String(255)),
        sa.Column('blockchain_tx_hash', sa.String(255)),
        sa.Column('kyc_status', sa.String(50), default='not_required'),
        sa.Column('aml_checked', sa.Boolean, default=False),
    ...
    op.create_table(
        ...
        sa.Column('method_id', postgresql.UUID(as_uuid=True), primary_key=True, default=uuid.uuid4),
        sa.Column('user_id', sa.String(255), nullable=False, index=True),
        sa.Column('payment_method', sa.String(50), nullable=False),
        sa.Column('provider', sa.String(50)),
        sa.Column('provider_method_id', sa.String(255)),
    ...
    op.create_table(
        ...
        sa.Column('rate_id', postgresql.UUID(as_uuid=True), primary_key=True, default=uuid.uuid4),
        sa.Column('from_currency', sa.String(20), nullable=False),
        sa.Column('to_currency', sa.String(20), nullable=False),
        sa.Column('rate', sa.Numeric(30, 18), nullable=False),
        sa.Column('volume_24h', sa.Numeric(30, 2)),
        sa.Column('source', sa.String(50)),
        sa.Column('timestamp', sa.DateTime(timezone=True), server_default=sa.text('now()')),
    )

    # Configuration Table for DatabaseConfigLoader
    op.create_table(
        'configuration',
        sa.Column('key',         sa.String(255),  primary_key=True,
                  comment='Dot-notation config key, e.g. nwtn.max_concurrent_queries'),
        sa.Column('value',       sa.Text,         nullable=False,
                  comment='String-encoded value; complex types use JSON encoding'),
